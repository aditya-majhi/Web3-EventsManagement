...
import { useCreateEvent } from "@/hooks/query.hooks";
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex items-center gap-3 pt-2">
            <input
              ...
              className="h-4 w-4 rounded border-[#252b3b] bg-[#0a0e1a] text-blue-600 focus:ring-blue-500 focus:ring-offset-0 cursor-pointer"
            />
            <label
              htmlFor="featured"
